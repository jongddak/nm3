...
public class M_F_Borad_share_Activity extends AppCompatActivity {
    ...
    private ListView M_V_board_shear_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        M_V_board_shear_list=(ListView)findViewById(R.id.M_V_board_shear_list);

        MyAdapter adapter=new MyAdapter(this,mTitle,mDescription,images);
        M_V_board_shear_list.setAdapter(adapter);//리스트에 어뎁터 설정
